...
@Component({
  selector: 'app-musicplayer-dark',
  templateUrl: './musicplayer-dark.page.html',
  styleUrls: ['./musicplayer-dark.page.scss'],
})

export class MusicplayerDarkPage implements OnInit {
  section_name: string;
  section_icon: string;
